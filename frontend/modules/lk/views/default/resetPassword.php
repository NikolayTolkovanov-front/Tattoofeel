...
$this->title = Yii::$app->params['title'] . ' | Личный кабинет | Новый пароль';

$this->params['breadcrumbs'][] = ['label' => 'Личный кабинет', 'url' => Url::to(['/lk'])];
$this->params['breadcrumbs'][] = ['label' => 'Новый пароль'];
?>
            ...
            <div class="grid-right-col__main">
                <div class="lk__box">
                    ...
                    <div class="lk-profile">
                        <div class="lk-profile-col">
                            <label class="like-ozn-labl">
                                <input name="ResetPasswordForm[password]" type="password" class="ozn-inp" />
                                <span class="label-text">Введите новый пароль *</span>
                            </label>
                        </div>
                    ...
                    <div class="lk-register-fields">
                        <input class="placeholder" name="ResetPasswordForm[password]" type="password"
