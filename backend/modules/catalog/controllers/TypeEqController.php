...
use backend\modules\catalog\models\search\TypeEqSearch;
use common\traits\FormAjaxValidationTrait;

class TypeEqController extends Controller
{
     ...
     * @param integer $id
     *
     * @return TypeEq the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TypeEq::findOne($id)) !== null) {
            return $model;
        }
