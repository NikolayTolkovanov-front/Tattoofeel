...
use backend\modules\content\models\search\ArticleNSearch;
use common\traits\FormAjaxValidationTrait;

class ArticleNController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new ArticleNSearch();
     ...
     * @param integer $id
     *
     * @return ArticleN the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ArticleN::findOne($id)) !== null) {
            return $model;
        }
