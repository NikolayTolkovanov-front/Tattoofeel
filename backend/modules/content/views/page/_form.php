...
<div class="row">
    <div class="col-xs-12">
        <?= $form->field($model, 'body')->widget(Imperavi::class, ['height'=>400]) ?>
    </div>
</div>
<div class="row">
    <div class="col-xs-6">
    ...
    <div class="col-xs-6">
        <?= $form->field($model, 'thumbnail_desc')->widget(Imperavi::class, ['height'=>200]) ?>
    </div>
</div>
<div class="row">
    <div class="col-xs-12">
...
<div class="row">
    <div class="col-xs-8">
        <div id="seo-snippet" class="seo-snippet">
            <a href="<?=Yii::$app->request->hostInfo."/{$model->slug}/"?>" target="_blank" class="seo-snippet-link">
                <h3 id="seo-snippet-title" class="seo-snippet-title"><?=$model->seo_title ?: 'Seo Заголовок'?></h3>
                <span id="seo-snippet-url" class="seo-snippet-url"><?=Yii::$app->request->hostInfo."/{$model->slug}/"?></span>
            </a>
