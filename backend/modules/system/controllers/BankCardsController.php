...
use backend\modules\system\models\search\BankCardsSearch;
...
class BankCardsController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new BankCardsSearch();
     ...
     * @param integer $id
     *
     * @return BankCards the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BankCards::findOne($id)) !== null) {
            return $model;
        }
