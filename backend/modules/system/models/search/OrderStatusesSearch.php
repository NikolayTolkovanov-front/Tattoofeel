...
class OrderStatusesSearch extends OrderStatuses
{
    ...
    {
        return [
            [['id', 'ms_status_id', 'title', 'ms_title'], 'string'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'ms_status_id', $this->ms_status_id]);
        $query->andFilterWhere(['like', 'owner', $this->title]);
        $query->andFilterWhere(['like', 'owner', $this->ms_title]);
