...
use common\models\query\ArticleNQuery;
...
/**
 * This is the model class for table "articleN".
 *
 * @property integer         $id
 ...
 *
 */
class ArticleN extends ActiveRecord
{
    ...
    /**
     * @return ArticleNQuery
     */
    public static function find()
    {
        return new ArticleNQuery(get_called_class());
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'thumbnail' => t_b('Картинка (735x662)'),
            'body' => t_b('Описание'),
