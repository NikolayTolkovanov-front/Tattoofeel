...
class Maintenance extends Component implements BootstrapInterface
{
     ...
     * @var string
     */
    public $maintenanceLayout = '@frontend/views/layouts/maintenance.php';
    /**
     * @var string
     */
    public $maintenanceView = '@frontend/views/site/maintenance.php';
    /**
     * @var string
     */
    ...
    public function bootstrap($app)
    {
        ...
        if ($enabled) {
            $this->maintenanceText = $this->maintenanceText ?: Yii::t('common', 'На сайте ведутся технические работы.');
